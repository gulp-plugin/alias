...
const tests: Record<string, Test> = {
  ...
  ["should support multiple imports per line"]: {
    ...
    output:
      "import module from 'module'; import Component from '../components/Component'",
  },
...
for (const [name, test] of Object.entries(tests)) {
  it(name, () =>
    test.error ? expect(run(test)).rejects.toThrow(test.error) : run(test)
  )
}
...
//       config: {
//         ...compilerOptions,
//         paths: { MyAlias: ["node_modules/@lib/MyAliasClass"] },
//         baseUrl: "./tasks",
//       },
//       cwd: "../",
//     },
